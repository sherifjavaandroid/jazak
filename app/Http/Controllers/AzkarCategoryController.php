...
class AzkarCategoryController extends Controller
{
     ...
     *
     * @param  \App\Models\AzkarCategory  $azkarCategory
     * @return \Illuminate\Http\Response
     */
    public function show($category_id)
    {
        $category = AzkarCategory::where('_id', $category_id)->first();

        if($category){
            return response()->json($category, 200);
        }else{
            return response()->json(["message" => "no Dua category found with this id!"], 400);
        }
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(AzkarCategory $azkarCategory)
    {
        //
    }
